...
class BaseTaskExecutorTest extends HermodBaseTest {
	...
	@Test
	void testFormatTaskExecutorException(TestInfo testInfo) throws Exception {
		try {
			enrichTestInfo(testInfo, EXP_NOT_NULL.toString());
			logger.debug(getStartTestLog());

			TaskExecutorException result = taskExecutor.formatTaskExecutorException(ERROR_MESSAGE, ERROR_CODE);
			...
			result = taskExecutor.formatTaskExecutorException(ERROR_MESSAGE, ERROR_CAUSE);
			...
			result = taskExecutor.formatTaskExecutorException(ERROR_MESSAGE);
			assertNotNull(result, getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getMessage(), getEndTestLog(TEST_AND_OK));
			...
			result = taskExecutor.formatTaskExecutorException(ERROR_TYPE, ERROR_CAUSE);
			assertNotNull(result, getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getMessage(), getEndTestLog(TEST_AND_OK));
			...
			result = taskExecutor.formatTaskExecutorException(ERROR_TYPE);
			assertNotNull(result, getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getMessage(), getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getCode(), getEndTestLog(TEST_AND_OK));
	...
	@Test
	void testIncludeAndFormatIntoTaskExecutorException(TestInfo testInfo) throws Exception {
		try {
			enrichTestInfo(testInfo, EXP_NOT_NULL.toString());
			logger.debug(getStartTestLog());

			TaskExecutorException result = taskExecutor.includeAndFormatIntoTaskExecutorException(ERROR_THROWABLE, ERROR_CODE);
			assertNotNull(result, getEndTestLogKO());
			assertNotNull(result.getMessage(), getEndTestLogKO());
			...
			result = taskExecutor.includeAndFormatIntoTaskExecutorException(ERROR_THROWABLE);
			assertNotNull(result, getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getMessage(), getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getCause(), getEndTestLog(TEST_AND_OK));
