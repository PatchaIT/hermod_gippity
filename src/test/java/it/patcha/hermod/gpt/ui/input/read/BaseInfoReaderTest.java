...
class BaseInfoReaderTest extends HermodBaseTest {
	...
	@InjectMocks
	private BaseInfoReaderTest.BaseInfoReaderImpl jobDispatcher;
	...
	void testHandleOptions(TestInfo testInfo) throws Exception {
		try {
			...
			HermodBean result = jobDispatcher.handleOptions(argsBean);
			...
			InfoReaderException exception =
					assertThrows(InfoReaderException.class, () -> jobDispatcher.handleOptions(null), getEndTestLog(TEST_AND_KO));
	...
	@Test
	void testFormatInfoReaderException(TestInfo testInfo) throws Exception {
		try {
			enrichTestInfo(testInfo, EXP_NOT_NULL.toString());
			logger.debug(getStartTestLog());

			InfoReaderException result = jobDispatcher.formatInfoReaderException(ERROR_MESSAGE, ERROR_CODE);
			assertNotNull(result, getEndTestLogKO());
			...
			result = jobDispatcher.formatInfoReaderException(ERROR_MESSAGE, ERROR_CAUSE);
			...
			result = jobDispatcher.formatInfoReaderException(ERROR_MESSAGE);
			assertNotNull(result, getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getMessage(), getEndTestLog(TEST_AND_OK));
			...
			result = jobDispatcher.formatInfoReaderException(ERROR_TYPE, ERROR_CAUSE);
			assertNotNull(result, getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getMessage(), getEndTestLog(TEST_AND_OK));
			...
			result = jobDispatcher.formatInfoReaderException(ERROR_TYPE);
			assertNotNull(result, getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getMessage(), getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getCode(), getEndTestLog(TEST_AND_OK));
	...
	@Test
	void testIncludeAndFormatIntoInfoReaderException(TestInfo testInfo) throws Exception {
		try {
			enrichTestInfo(testInfo, EXP_NOT_NULL.toString());
			logger.debug(getStartTestLog());

			InfoReaderException result = jobDispatcher.includeAndFormatIntoInfoReaderException(ERROR_THROWABLE, ERROR_CODE);
			assertNotNull(result, getEndTestLogKO());
			assertNotNull(result.getMessage(), getEndTestLogKO());
			...
			result = jobDispatcher.includeAndFormatIntoInfoReaderException(ERROR_THROWABLE);
			assertNotNull(result, getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getMessage(), getEndTestLog(TEST_AND_OK));
			assertNotNull(result.getCause(), getEndTestLog(TEST_AND_OK));
